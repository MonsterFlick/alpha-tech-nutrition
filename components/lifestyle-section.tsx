...
const socialPosts = [
  { handle: "@marcus_fit", text: "Alpha Tech Prime Whey gives me the cleanest post-workout recovery. 10/10 flavor and no bloating 🔥", likes: "2.4k" },
  { handle: "@alex_iron", text: "Anabolic Lean Muscle Builder is unmatched for strength and lean gains. Pure quality.", likes: "1.8k" },
  { handle: "@dan_gains", text: "Alpha Super Mass Gainer is hands down the best mass formula on the market.", likes: "956" },
]
